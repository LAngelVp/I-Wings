...
export class ButtonsCategoriesFoodComponent {
  ...
  categoriaActual: keyof ProductosInterface | null = null;

  mostrarProductos(categoria: keyof ProductosInterface) {
    this.categoriaActual = categoria;
  
    const productosCategoria = this.productos[categoria] || [];
    this.productosMostrador = this.filtrarProductos(productosCategoria, this.filtroBusqueda);
  }

  filtrarProductos(productos: any[], filtro: string): any[] {
